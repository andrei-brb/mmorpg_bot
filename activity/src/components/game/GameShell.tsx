    ...
    <div className="app-bg min-h-[100dvh] flex flex-col text-foreground overflow-x-clip">
      ...
      >
        ...
        >
          ...
          <div className="game-frame-inner flex w-full min-w-0 flex-col flex-1 min-h-0">
            ...
            <div
              className={
                shellChromeHidden
                  ? "sm:px-1 flex w-full min-w-0 flex-col flex-1 min-h-0 -mt-1"
                  : "sm:px-1 flex w-full min-w-0 flex-col flex-1 min-h-0"
              }
            >
              <GameTabs
